...
![Retrieval discipline — a tier querying its own partitioned index for an as-of pointer then reading the frozen blob, versus a global index that retrieves across the firewall and treats a stale chunk as truth](../assets/retrieval-discipline.svg)
